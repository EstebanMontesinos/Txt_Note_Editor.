...
public class Editor extends JFrame implements ActionListener {
            ...
            MenuItem fname1,fname2,fname3,fname4,fname5;
            MenuItem fstyle1,fstyle2,fstyle3,fstyle4,fstyle5;
...
optionbar=new MenuBar();
setMenuBar(optionbar);

file=new Menu("File");//setting up the menus 
edit=new Menu("Edit");
...
file.add(item1=new MenuItem("New..."));//options 
...
font.add(fname5=new MenuItem("Times"));
...
font1.add(fstyle5=new MenuItem("Regular"));
...
{
dispose();
Editor note1 = new Editor("Note application");
